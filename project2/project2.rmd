...
model_evaluations <- rbind(
  ...
  Model.Name = "Company",
  Model.Type = "univariate",
  AUC = calc_auc(company_pred, test_set[target]),
  Log.Likelihood = calc_log_likelihood(company_pred, test_set[, target])
))
...
model_evaluations <- rbind(
  ...
  Model.Type = "univariate",
  AUC = calc_auc(title_pred, test_set[target]),
  Log.Likelihood = calc_log_likelihood(title_pred, test_set[, target])
))
```
