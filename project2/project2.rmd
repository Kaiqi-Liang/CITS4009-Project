...
plot(clust_single, labels=FALSE, main="Cluster Dendrogram for Single Linkage")

# Ward D2 Linkage 
clust_cent <-  hclust(dist_matrix, method <- "centroid")
plot(clust_cent,labels=FALSE, main="Cluster Dendrogram for Centroid Linkage")

# Complete Linkage
clust_complete <-  hclust(dist_matrix, method <- "complete")
plot(clust_complete, labels=FALSE, main="Cluster Dendrogram for Complete Linkage") 

# Average Linkage
clust_average <-  hclust(dist_matrix, method <- "average")
plot(clust_average, labels=FALSE, main="Cluster Dendrogram for Average Linkage")

# Ward D Linkage
clust_wardD<-  hclust(dist_matrix, method <- "ward.D")
plot(clust_wardD,labels=FALSE, main="Cluster Dendrogram for Ward.D Linkage")

# Ward D2 Linkage 
clust_wardD2 <-  hclust(dist_matrix, method <- "ward.D2")
plot(clust_wardD2,labels=FALSE, main="Cluster Dendrogram for Ward.D2 Linkage")
...
dend_classes9 = cutree(clust_wardD, k = 1:9) # cuts the tree at various levels to get maximum of k clusters
...
PCA <- prcomp(scaled_df) # Calculate the principal components of scaled_df
PCA
...
qplot(c(1:10), cumsum(eigvals)/sum(eigvals)*100) + 
  geom_line() + 
  xlab("Index") + 
