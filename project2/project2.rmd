...
Select the variables with an average AUC higher than 0.6 to be the selected features used in model trainings later on.
...
```{r}
ggplot(df) +
  geom_bar(aes(x = cluster, fill = State), position = "fill")
```
