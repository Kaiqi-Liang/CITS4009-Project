...
# Ward D2 Linkage 
clust_wardD22 <-  hclust(dist_matrix, method <- "ward.D2")
plot(clust_wardD22,labels=FALSE, main="Ward.D2 Linkage")
...
dend_classes = cutree(clust_wardD2, k = 1:9) 
...
```{r}
aggregate(df[,num_var], by=list(cluster=df$cluster), mean)
```
