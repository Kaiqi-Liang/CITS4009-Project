...
c1 = plot(clust_complete, labels=FALSE, main="Cluster Dendrogram for Complete Linkage") 

# Averafe 
clust_average <-  hclust(dist_matrix, method <- "average")

c2 = plot(clust_average, labels=FALSE, main="Cluster Dendrogram for Average Linkage")

# Calculate the clusters
clust_wardD<-  hclust(dist_matrix, method <- "ward.D")

# Plot the dendrogram
c3 = plot(clust_wardD,labels=FALSE, main="Cluster Dendrogram for Ward.D Linkage")

# Calculate the clusters
clust_wardD2 <-  hclust(dist_matrix, method <- "ward.D2")

# Plot the dendrogram
c4 = plot(clust_wardD2,labels=FALSE, main="Cluster Dendrogram for Ward.D2 Linkage")
